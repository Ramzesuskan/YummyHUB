...
-- Добавь в раздел UI (например, в MiscellaneousBOX)
local KillBOX = GeneralTab:AddRightTabbox("Script Control") do
    local KillTab = KillBOX:AddTab("Kill Nigger")
    
    KillTab:AddButton("Do It", function()
        -- Отключаем хуки
        if oldNamecall then
